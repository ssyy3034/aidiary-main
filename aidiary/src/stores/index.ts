    ...
    (set) => ({
      ...
      login: (token: string, user: UserProfile) => {
        ...
        set({
          ...
          userInfo: user,
          hasCharacter: !!user.child,
          characterData: user.child
            ? {
                childName: user.child.childName,
                childBirthday: user.child.childBirthday || "",
                characterImage: user.child.characterImage || "",
                parent1Features: "",
                parent2Features: "",
                prompt: "",
                gptResponse: "",

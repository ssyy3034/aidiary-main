...
- [html-webpack-harddiREMOVEDplugin](https://github.com/jantimon/html-webpack-harddiREMOVEDplugin) can be used to always write to disk the html file, useful when webpack-dev-server / HMR are being used

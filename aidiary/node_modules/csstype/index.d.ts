...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`maREMOVEDborder-mode`** CSS property specifies the blending mode used in a mask border.
   *
  ...
  /**
   * The **`maREMOVEDborder-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image-outset)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-maREMOVEDbox-image-outset)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-outset
   */
  maskBorderOutset?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`maREMOVEDborder-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   *
   * **Initial value**: `stretch`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image-repeat)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-maREMOVEDbox-image-repeat)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-repeat
   */
  maskBorderRepeat?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`maREMOVEDborder-slice`** CSS property divides the image set by `maREMOVEDborder-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image-slice)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-maREMOVEDbox-image-slice)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-slice
   */
  maskBorderSlice?: Property.MaskBorderSlice | undefined;
  /**
   * The **`maREMOVEDborder-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   *
   * **Initial value**: `none`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image-source)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-maREMOVEDbox-image-source)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-source
   */
  maskBorderSource?: Property.MaskBorderSource | undefined;
  /**
   * The **`maREMOVEDborder-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   *
   * **Initial value**: `auto`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image-width)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-maREMOVEDbox-image-width)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-width
   */
  maskBorderWidth?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`maREMOVEDclip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDclip
   */
  maskClip?: Property.MaskClip | undefined;
  /**
   * The **`maREMOVEDcomposite`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
   ...
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDcomposite
   */
  maskComposite?: Property.MaskComposite | undefined;
  /**
   * The **`maREMOVEDimage`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `maREMOVEDmode` property.
   *
   * **Syntax**: `<maREMOVEDreference>#`
   *
   * **Initial value**: `none`
   *
   * | Chrome  | Firefox |  Safari  | Edge  | IE  |
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDimage
   */
  maskImage?: Property.MaskImage | undefined;
  /**
   * The **`maREMOVEDmode`** CSS property sets whether the mask reference defined by `maREMOVEDimage` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   *
   ...
   * | **120** | **53**  | **15.4** | n/a  | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDmode
   */
  maskMode?: Property.MaskMode | undefined;
  /**
   * The **`maREMOVEDorigin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   *
   * **Initial value**: `border-box`
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDorigin
   */
  maskOrigin?: Property.MaskOrigin | undefined;
  /**
   * The **`maREMOVEDposition`** CSS property sets the initial position, relative to the mask position layer set by `maREMOVEDorigin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   *
   ...
   * | 1 _-x-_ |         | 3.1 _-x-_ |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDposition
   */
  maskPosition?: Property.MaskPosition<TLength> | undefined;
  /**
   * The **`maREMOVEDrepeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   *
   * **Initial value**: `repeat`
   ...
   * | 1 _-x-_ |         | 3.1 _-x-_ |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDrepeat
   */
  maskRepeat?: Property.MaskRepeat | undefined;
  /**
   * The **`maREMOVEDsize`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   *
   * **Initial value**: `auto`
   ...
   * | 4 _-x-_ |         | 4 _-x-_  |       |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDsize
   */
  maskSize?: Property.MaskSize<TLength> | undefined;
  /**
   * The **`maREMOVEDtype`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   *
   ...
   * | **24** | **35**  | **7**  | n/a  | No  |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDtype
   */
...
export interface StandardShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`maREMOVEDborder`** CSS shorthand property lets you create a mask along the edge of an element's border.
   *
   * **Syntax**: `<'maREMOVEDborder-source'> || <'maREMOVEDborder-slice'> [ / <'maREMOVEDborder-width'>? [ / <'maREMOVEDborder-outset'> ]? ]? || <'maREMOVEDborder-repeat'> || <'maREMOVEDborder-mode'>`
   *
   * |              Chrome              | Firefox |             Safari             | Edge | IE  |
   * | :------------------------------: | :-----: | :----------------------------: | :--: | :-: |
   * | **1** _(-webkit-maREMOVEDbox-image)_ |   No    |            **17.2**            | n/a  | No  |
   * |                                  |         | 3.1 _(-webkit-maREMOVEDbox-image)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder
   */
...
export interface VendorLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * If a `maREMOVEDimage` is specified, `-webkit-maREMOVEDattachment` determines whether the mask image's position is fixed within the viewport, or scrolls along with its containing block.
   *
   * **Syntax**: `<attachment>#`
   *
   * **Initial value**: `scroll`
  ...
  /**
   * The **`-webkit-maREMOVEDcomposite`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-maREMOVEDimage` property.
   *
  ...
  /**
   * The `-webkit-maREMOVEDposition-x` CSS property sets the initial horizontal position of a mask image.
   *
  ...
  /**
   * The `-webkit-maREMOVEDposition-y` CSS property sets the initial vertical position of a mask image.
   *
  ...
  /**
   * The `-webkit-maREMOVEDrepeat-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
  ...
  /**
   * The `-webkit-maREMOVEDrepeat-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   *
   * **Initial value**: `repeat`
...
export interface VendorShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * The **`mask`** CSS shorthand property hides an element (partially or fully) by masking or clipping the image at specific points.
   *
   * **Syntax**: `[ <maREMOVEDreference> || <position> [ / <bg-size> ]? || <repeat-style> || [ <box> | border | padding | content | text ] || [ <box> | border | padding | content ] ]#`
   */
...
export interface StandardLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `alpha`
   */
  "maREMOVEDborder-mode"?: Property.MaskBorderMode | undefined;
  /**
   * The **`maREMOVEDborder-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-outset
   */
  "maREMOVEDborder-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`maREMOVEDborder-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-repeat
   */
  "maREMOVEDborder-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`maREMOVEDborder-slice`** CSS property divides the image set by `maREMOVEDborder-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-slice
   */
  "maREMOVEDborder-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`maREMOVEDborder-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-source
   */
  "maREMOVEDborder-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`maREMOVEDborder-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder-width
   */
  "maREMOVEDborder-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`maREMOVEDclip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <geometry-box> | no-clip ]#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDclip
   */
  "maREMOVEDclip"?: Property.MaskClip | undefined;
  /**
   * The **`maREMOVEDcomposite`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
   * **Syntax**: `<compositing-operator>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDcomposite
   */
  "maREMOVEDcomposite"?: Property.MaskComposite | undefined;
  /**
   * The **`maREMOVEDimage`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `maREMOVEDmode` property.
   *
   * **Syntax**: `<maREMOVEDreference>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDimage
   */
  "maREMOVEDimage"?: Property.MaskImage | undefined;
  /**
   * The **`maREMOVEDmode`** CSS property sets whether the mask reference defined by `maREMOVEDimage` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDmode
   */
  "maREMOVEDmode"?: Property.MaskMode | undefined;
  /**
   * The **`maREMOVEDorigin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDorigin
   */
  "maREMOVEDorigin"?: Property.MaskOrigin | undefined;
  /**
   * The **`maREMOVEDposition`** CSS property sets the initial position, relative to the mask position layer set by `maREMOVEDorigin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDposition
   */
  "maREMOVEDposition"?: Property.MaskPosition<TLength> | undefined;
  /**
   * The **`maREMOVEDrepeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDrepeat
   */
  "maREMOVEDrepeat"?: Property.MaskRepeat | undefined;
  /**
   * The **`maREMOVEDsize`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDsize
   */
  "maREMOVEDsize"?: Property.MaskSize<TLength> | undefined;
  /**
   * The **`maREMOVEDtype`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDtype
   */
  "maREMOVEDtype"?: Property.MaskType | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `[ pack | next ] || [ definite-first | ordered ]`
...
export interface StandardShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/maREMOVEDborder
   */
  "maREMOVEDborder"?: Property.MaskBorder | undefined;
  /**
   * The **`offset`** CSS shorthand property sets all the properties required for animating an element along a defined path.
   *
   * **Syntax**: `[ <'offset-position'>? [ <'offset-path'> [ <'offset-distance'> || <'offset-rotate'> ]? ]? ]! [ / <'offset-anchor'> ]?`
...
export interface VendorLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `scroll`
   */
  "-webkit-maREMOVEDattachment"?: Property.WebkitMaskAttachment | undefined;
  /**
   * The **`maREMOVEDborder-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * **Initial value**: `0`
   */
  "-webkit-maREMOVEDbox-image-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`maREMOVEDborder-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * **Initial value**: `stretch`
   */
  "-webkit-maREMOVEDbox-image-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`maREMOVEDborder-slice`** CSS property divides the image set by `maREMOVEDborder-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * **Initial value**: `0`
   */
  "-webkit-maREMOVEDbox-image-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`maREMOVEDborder-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * **Initial value**: `none`
   */
  "-webkit-maREMOVEDbox-image-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`maREMOVEDborder-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * **Initial value**: `auto`
   */
  "-webkit-maREMOVEDbox-image-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`maREMOVEDclip`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <box> | border | padding | content | text ]#`
   ...
   * **Initial value**: `border`
   */
  "-webkit-maREMOVEDclip"?: Property.WebkitMaskClip | undefined;
  /**
   * The **`-webkit-maREMOVEDcomposite`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-maREMOVEDimage` property.
   *
   * **Syntax**: `<composite-style>#`
   ...
   * **Initial value**: `source-over`
   */
  "-webkit-maREMOVEDcomposite"?: Property.WebkitMaskComposite | undefined;
  /**
   * The **`maREMOVEDimage`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `maREMOVEDmode` property.
   *
   * **Syntax**: `<maREMOVEDreference>#`
   ...
   * **Initial value**: `none`
   */
  "-webkit-maREMOVEDimage"?: Property.WebkitMaskImage | undefined;
  /**
   * The **`maREMOVEDorigin`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `[ <box> | border | padding | content ]#`
   ...
   * **Initial value**: `padding`
   */
  "-webkit-maREMOVEDorigin"?: Property.WebkitMaskOrigin | undefined;
  /**
   * The **`maREMOVEDposition`** CSS property sets the initial position, relative to the mask position layer set by `maREMOVEDorigin`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * **Initial value**: `0% 0%`
   */
  "-webkit-maREMOVEDposition"?: Property.WebkitMaskPosition<TLength> | undefined;
  /**
   * The `-webkit-maREMOVEDposition-x` CSS property sets the initial horizontal position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | left | center | right ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-maREMOVEDposition-x"?: Property.WebkitMaskPositionX<TLength> | undefined;
  /**
   * The `-webkit-maREMOVEDposition-y` CSS property sets the initial vertical position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | top | center | bottom ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-maREMOVEDposition-y"?: Property.WebkitMaskPositionY<TLength> | undefined;
  /**
   * The **`maREMOVEDrepeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-maREMOVEDrepeat"?: Property.WebkitMaskRepeat | undefined;
  /**
   * The `-webkit-maREMOVEDrepeat-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-maREMOVEDrepeat-x"?: Property.WebkitMaskRepeatX | undefined;
  /**
   * The `-webkit-maREMOVEDrepeat-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-maREMOVEDrepeat-y"?: Property.WebkitMaskRepeatY | undefined;
  /**
   * The **`maREMOVEDsize`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * **Initial value**: `auto auto`
   */
  "-webkit-maREMOVEDsize"?: Property.WebkitMaskSize<TLength> | undefined;
  /**
   * The **`max-inline-size`** CSS property defines the horizontal or vertical maximum size of an element's block, depending on its writing mode. It corresponds to either the `max-width` or the `max-height` property, depending on the value of `writing-mode`.
   *
   * **Syntax**: `<'max-width'>`
...
export interface VendorShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Syntax**: `<'maREMOVEDborder-source'> || <'maREMOVEDborder-slice'> [ / <'maREMOVEDborder-width'>? [ / <'maREMOVEDborder-outset'> ]? ]? || <'maREMOVEDborder-repeat'> || <'maREMOVEDborder-mode'>`
   */
  "-webkit-maREMOVEDbox-image"?: Property.MaskBorder | undefined;
  /**
   * The **`text-emphasis`** CSS property applies emphasis marks to text (except spaces and control characters). It is a shorthand for `text-emphasis-style` and `text-emphasis-color`.
   *
   * **Syntax**: `<'text-emphasis-style'> || <'text-emphasis-color'>`

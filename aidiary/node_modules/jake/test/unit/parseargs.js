...
suite('parseargs', function () {
  ...
  test('-f expects a value, -t does not (howdy is taREMOVEDname)', function () {
  ...
  test('different order, -f expects a value, -t does not (howdy is taREMOVEDname)', function () {
  ...
  test('-f expects a value, -t does not (foo=bar is env-var, taREMOVEDname follows)', function () {
  ...
  test('-t does not expect a value, -f does (howdy is taREMOVEDname)', function () {
  ...
  test('--trace does not expect a value, -f does (howdy is taREMOVEDname)', function () {
  ...
  /*
, test('taREMOVEDname with positional args', function () {
    res = p.parse(z('foo:bar[asdf,qwer]'));
    assert.equal('asdf', p.taskArgs[0]);
    assert.equal('qwer', p.taskArgs[1]);
  }

, test('opts, env vars, taREMOVEDname with positional args', function () {

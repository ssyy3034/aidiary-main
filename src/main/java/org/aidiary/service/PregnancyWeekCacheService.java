...
public class PregnancyWeekCacheService {
    ...
    /**
     * 개인화된 주차 콘텐츠 조회.
     * 조회 우선순위: Caffeine → Redis → DB → Flask(Gemini)
     */
    public PregnancyWeekDTO getPersonalizedWeekContent(UserContext ctx) {
        ...
        // 컨텍스트가 없는 사용자(일기/건강기록 미입력)는 공통 응답
    ...
    /**
     * 컨텍스트 없는 사용자용 공통 주차 콘텐츠 (기존 로직 유지).
     */
